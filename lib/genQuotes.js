...
const tokens = [
  ...
  { symbol: "PenguinCoin", name: "pengu" },

  { symbol: "PepeCoin", name: "Pepe" },
...
const generatePerpsQuote = async () => {
    ...
    const perpsPrompt = `As a professional crypto trader, share actionable insights about ${
      selectedToken.name
    } (${
      selectedToken.symbol
    }) in the futures market. With a current price of $${tokenPrice.usd.toFixed(
      2
    )}, it's essential to monitor market trends. Consider key support and resistance levels. And some of your opinions Include this text: "Trade your fav token at just.bet with 1000x leverage. Stay informed and trade responsibly."`;
